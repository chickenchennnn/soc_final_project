...
#define config_mm  (*(volatile uint32_t*)0x30000004)
#define config_qs  (*(volatile uint32_t*)0x30000008)
...
#define d_mm_in     (*(volatile uint32_t*)0x300000a0)
#define d_mm_out    (*(volatile uint32_t*)0x300000a4)

#define d_qs_in     (*(volatile uint32_t*)0x300000c0)
#define d_qs_out    (*(volatile uint32_t*)0x300000c4)
